...
namespace StringManipulationChallenge
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            *
            */
            string upperCase = Program.StringToUpper("hello world");
            Console.WriteLine(upperCase);

            string lowerCase = Program.StringToLower("HELLO WORLD");
            Console.WriteLine(lowerCase);

            string trimCase = Program.StringTrim("    Trim this!    ");
            Console.WriteLine(trimCase);

            string subCase = Program.StringSubstring("C# is cool", 6, 4);
            Console.WriteLine(subCase);

            int searchCase = Program.SearchChar("C# is awesome", 'a');
            Console.WriteLine(searchCase);

            string concatCase = Program.ConcatNames("Monica", "Geller");
            Console.WriteLine(concatCase);
        ...
        public static string StringTrim(string usersStringWithWhiteSpace)
        {
            ...
            Console.WriteLine(usersStringWithWhiteSpace);
        ...
        public static string StringSubstring(string x, int firstElement, int lengthOfSubsring)
        {
            ...
            Console.WriteLine(x, firstElement, lengthOfSubsring);
        ...
        public static int SearchChar(string userInputString, char charUserWants)
        {
            ...
            Console.WriteLine(userInputString, charUserWants);
