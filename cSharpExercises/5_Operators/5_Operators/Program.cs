...
namespace _5_OperatorsChallenge
{
    public class Program
    {
        ...
        public static bool And(int num1, int num2)
        {
            ...
            //README: Implement the And() method that checks if the first number is not equal to 0 and if it's greater than the second number
            if (num1 != 0 && num1 >= num2) 
            {
                return true;
            }
        ...
        public static bool Or(int num1, int num2)
        {
            ...
            //README: Implement the Or() method that checks if the first number is equal to the second number or if the first number is less than 0
            if (num1 == num2 || num1 < 0) 
            {
                return true;
            } 
